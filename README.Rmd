...
Suppose you have an array of coordinates that spans the globe. You may want to cluster them based on proximity (e.g. with 4 km), then define an enveloping polygon for each cluster (i.e., a convex hull). You may also want to give each polygon a name based on the nearest city, or some other type of structure (e.g. a marine port). Finally, you may want to compute summary statistics for each polygon, based on the characteristics of the points you provided. This package does all that.
